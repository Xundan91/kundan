...
image: https://assets.kundan.com/images/blog/react-wheel-picker.webp?t=1747747932
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://kundan.com/r/wheel-picker-block-01.json"
  codeCollapsible
/>

## About

The Wheel Picker component is built on top of [React Wheel Picker](https://react-wheel-picker.kundan.com).
...
See the [React Wheel Picker](https://react-wheel-picker.kundan.com/docs/getting-started) documentation for more information.
...
<ComponentPreview
  ...
  openInV0Url="https://kundan.com/r/wheel-picker-block-02.json"
  codeCollapsible
/>
